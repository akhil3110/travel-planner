...
const TripsPage = async() => {
    ...
    if(!session){
        return <div className="flex justify-center items-center h-screen text-gray-700 text-xl font-extrabold">
            {" "}
            Please Sign In
        </div>
    }
        ...
        <div className="space-y-6 container mx-auto px-4 py-8">
            ...
            <Card>
                ...
                <CardContent>
                    <p>
                        {trips.length === 0 ? 
                            "Start Planning  you first trip ny clikikng the button above." 
                    ...
                    {trips.length === 0 ? (
                        <Card>
                            <CardContent className="flex flex-col items-center justify-center py-8">
                                <h3 className="text-xl font-medium mb-2">There are no trips yet.</h3>
                                <p className="text-center mb-4 max-w-4"> Start Planning your adventure  by creating your first trip</p>
                            </CardContent>
                            <Link href={"/trips/new"}>
